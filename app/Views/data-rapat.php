...
<!-- modal add user -->
<div class="modal fade" id="modalTambahRapat" tabindex="-1" role="dialog" aria-labelledby="modalManajemenUserLabel" aria-hidden="true">
...
<!-- end-model edit user-->
<!-- modal add user -->
<div class="modal fade" id="modalManajemenUser" tabindex="-1" role="dialog" aria-labelledby="modalManajemenUserLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" >
    <div class="modal-content">
      <div class="modal-header">
        <div class="d-flex justify-content-center w-100" >
